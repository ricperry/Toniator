...
impl PatternId {
    ...
    pub const QUADRATIC_RADIAL_SPIRAL_V1: Self =
        Self(Cow::Borrowed("parametric-paths.quadratic-radial-spiral.v1"));
    pub const WAVE_LINE_FIELD_V1: Self =
        Self(Cow::Borrowed("structured-fields.wave-line-field.v1"));
