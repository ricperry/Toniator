...
and canonical-region foundation on 2026-08-25. Stages 20O–20S and later Stages
...
and canonical-region/render foundations. Concrete region sources, region
treatments, heterogeneous composites, and multiframe/transition authority
remain absent.
...
| Regions/cells/faces | Geometry-owned canonical-region contract and render fill boundary; no concrete source yet | No Voronoi or general guide-face output; canvas must not create cells. | 20O Voronoi, 20P guide faces, and 20Q realization build on 20N. | **Structural:** region source/treatment changes miss realization/downstream; final clip stays consumer-only. |
...
| Realization | `PatternOutputLayer`, ordered per-output settings, canonical circle/closed-shape marks, guide paths, connected thickness response, reusable compact stroke outlines, and canonical-region fill units | Concrete region source/treatment and composite output do not exist yet. | 20O–20Q regions and 20R composites build on 20N. | **Realization:** prototype, geometry response, path/region treatment miss realization/downstream while retaining family. |
...
| Canonical geometry/render/export | Canonical circles, closed marks, guide paths, compact filled strokes, canonical-region fill units, renderer scene, and engine preview/raster/SVG consumers | Concrete region sources/treatments and composites are missing; renderers must not generate topology. | 20O–20Q region production and 20R composites build on the 20N boundary. | Canonical content follows structural/realization changes; raster target/AA/background are **presentation** consumers. |
...
| 20O Ordinary Voronoi Regions | Guard-inclusive ordinary Voronoi regions from grid or dispersion sites, exact-duplicate co-ownership, and bounded deterministic topology. | Guide cells, power diagrams, UI. | geometry/patterns/render; 20A/20N. | Guard/duplicate/degeneracy/canonical-region/PNG-SVG tests. | None. | Planned; separate contract and gate. |
