...
mod tests {
    use super::*;
    use crate::{
        DefinitionParameterScope, LiteralValue, OutputChannelId, PatternDefinitionFingerprint,
        PatternDefinitionRegistryError, PatternDefinitionSource, PatternFamily, PatternId,
        PatternOutputKind, RecipePortType, serialize_tnpattern,
    };
