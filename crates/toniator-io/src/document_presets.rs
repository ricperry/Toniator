...
use super::{
    DOCUMENT_PRESET_FORMAT_VERSION, DOCUMENT_SCHEMA_VERSION, DocumentConfigurationDtoV7, LoadError,
...
pub fn save_document_preset(
    ...
    let envelope = DocumentPresetEnvelopeDto {
        ...
        configuration: DocumentConfigurationDtoV7::from_configuration(configuration)
